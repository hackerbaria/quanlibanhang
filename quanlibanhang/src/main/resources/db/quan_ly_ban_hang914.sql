...
--
-- Host: localhost
-- Generation Time: Sep 13, 2016 at 10:59 PM
...
ALTER TABLE `hang_hoa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_loai_hang_hoa` (`id_loai_hang_hoa`),
  ADD KEY `id_nhom_hang` (`id_nhom_hang`),
...
ALTER TABLE `kho`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_nhan_vien_quan_ly` (`id_nhan_vien_quan_ly`);
...
ALTER TABLE `khu_vuc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_nguoi_quan_ly` (`id_nguoi_quan_ly`);
...
ALTER TABLE `nguoi_dung`
  ...
  ADD KEY `id_phan_quyen` (`id_phan_quyen`);
...
--
ALTER TABLE `hang_hoa`
  ADD CONSTRAINT `hang_hoa_ibfk_4` FOREIGN KEY (`id_kho`) REFERENCES `kho` (`id`),
  ADD CONSTRAINT `hang_hoa_ibfk_1` FOREIGN KEY (`id_loai_hang_hoa`) REFERENCES `loai_hang_hoa` (`id`),
  ADD CONSTRAINT `hang_hoa_ibfk_2` FOREIGN KEY (`id_nhom_hang`) REFERENCES `nhom_hang` (`id`),
  ADD CONSTRAINT `hang_hoa_ibfk_3` FOREIGN KEY (`id_nha_phan_phoi`) REFERENCES `nha_phan_phoi` (`id`);
...
ALTER TABLE `hoa_don`
  ...
  ADD CONSTRAINT `hoa_don_ibfk_1` FOREIGN KEY (`id_hang_hoa`) REFERENCES `hang_hoa` (`id`);

--
-- Constraints for table `khach_hang`
--
ALTER TABLE `khach_hang`
  ADD CONSTRAINT `khach_hang_ibfk_1` FOREIGN KEY (`id_khu_vuc`) REFERENCES `khu_vuc` (`id`);

--
-- Constraints for table `kho`
--
ALTER TABLE `kho`
  ADD CONSTRAINT `kho_ibfk_1` FOREIGN KEY (`id_nhan_vien_quan_ly`) REFERENCES `nhan_vien` (`id`);

--
-- Constraints for table `khu_vuc`
--
ALTER TABLE `khu_vuc`
  ADD CONSTRAINT `khu_vuc_ibfk_2` FOREIGN KEY (`id_nguoi_quan_ly`) REFERENCES `nhan_vien` (`id`),
  ADD CONSTRAINT `khu_vuc_ibfk_1` FOREIGN KEY (`id_nguoi_quan_ly`) REFERENCES `nhan_vien` (`id`);

--
-- Constraints for table `lich_su_ban_hang`
--
ALTER TABLE `lich_su_ban_hang`
  ADD CONSTRAINT `lich_su_ban_hang_ibfk_2` FOREIGN KEY (`id_hang_hoa`) REFERENCES `hang_hoa` (`id`),
  ADD CONSTRAINT `lich_su_ban_hang_ibfk_1` FOREIGN KEY (`id_hoa_don`) REFERENCES `hoa_don` (`id`);

--
-- Constraints for table `nguoi_dung`
--
ALTER TABLE `nguoi_dung`
  ADD CONSTRAINT `nguoi_dung_ibfk_2` FOREIGN KEY (`id_phan_quyen`) REFERENCES `phan_quyen` (`id`),
  ADD CONSTRAINT `nguoi_dung_ibfk_1` FOREIGN KEY (`id_nhan_vien`) REFERENCES `nhan_vien` (`id`);

--
-- Constraints for table `nhan_vien`
--
ALTER TABLE `nhan_vien`
  ADD CONSTRAINT `nhan_vien_ibfk_1` FOREIGN KEY (`id_bo_phan`) REFERENCES `bo_phan` (`id`);

--
-- Constraints for table `nhat_ky_he_thong`
--
ALTER TABLE `nhat_ky_he_thong`
  ADD CONSTRAINT `nhat_ky_he_thong_ibfk_1` FOREIGN KEY (`id_nguoi_dung`) REFERENCES `nguoi_dung` (`id`);

--
-- Constraints for table `nha_phan_phoi`
--
ALTER TABLE `nha_phan_phoi`
  ADD CONSTRAINT `nha_phan_phoi_ibfk_1` FOREIGN KEY (`id_khu_vuc`) REFERENCES `khu_vuc` (`id`);
