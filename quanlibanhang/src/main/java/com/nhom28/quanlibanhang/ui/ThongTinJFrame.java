 ...
 * @author Google
 */
public class ThongTinJFrame extends javax.swing.JFrame {

	
    /**
     * Creates new form ThongTinJFrame
     */
    public ThongTinJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongTinJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongTinJFrame().setVisible(true);
            }
        });
    }
