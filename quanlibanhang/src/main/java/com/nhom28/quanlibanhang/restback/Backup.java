...
public class Backup {
    ...
    public String getData(String host, String port, String user, String password, String db) {
        ...
        try {
            ...
            run = Runtime.getRuntime().exec(Mysqlpath + "mysqldump --host=" + host + " --port=" + port + " --user=" + user + " --password=" + password + " --compact --complete-insert --extended-insert " + "--skip-comments --skip-triggers " + db);
